...
<footer class="footer">
  <div class="container">
    ...
    <div class="col-md-3 social">
      ...
      <a href="#" class="social-icon" target="_blank"><img src="img/icons/instagram.png" alt="Instagram icon" height="20" width="20" title="Follow us on instagram!" placeholder="Instagram"></a>
    </div>
  </div>
  <div class="separator"></div>
  <h6 class="copyright">Copyright © 2018 CodeTrip</h6>
</footer>
