...
<main>
  <div class="presentation client-side">
    <div class="container">
      <div class="col-md-6">
        <img src="img/client.png" alt="Two kids programming a robot, using a computer">
      </div>
  ...
  <div class="presentation server-side">
    <div class="container">
      ...
      <div class="col-md-6">
        <img src="img/server.png" alt="A business man keeping files on several computer servers">
      </div>
    </div>
  </div>
  <div class="courses">
