...
<main>
  <div id="signuppage">
    <div class="intro">
      ...
      <h6>Please, read input requirements in the <a href="help.php" class="basic-color">Help</a> section of the website.<br>In case you are facing issues, you may also contact us at <span class="basic-color">help@codeplayground.gr</span>.--></h6>
    </div>
